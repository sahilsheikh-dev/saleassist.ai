...
import VideoRev from "../../assests/sub-banner-icons/video-review.svg";
import BanVideoRev from "../../assests/sub-banner-icons/banner/video-review.svg";
  ...
  render() {
    return (
      <React.Fragment>
        <Helmet>
          <meta charSet="utf-8"/>
          <title>SaleAssist - Video Review</title>
        </Helmet>
      <Layout1 btn="book-a-demo-white-btn safemeet-btn" color="safemeet-navitem white" activeClass="active-feature active-feature-white">
        <SubBanner
          ...
          image={VideoRev}
          span="Video Review"
          title="Proper reviews with feeling."
          details="Review is the best way for us to grow.We have given a new way to give review.Your feedback will makes us better."
          btn="Watch Demo"
          path="/video-review-demo"/>
        <TrustCompanies/>
        <ShowUHow/>
        <SimpleCardShow/>
        <DoEvenMore/>
