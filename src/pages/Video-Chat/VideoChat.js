...
import ViChat from "../../assests/sub-banner-icons/video-chat.svg";
import VideoChatImage from "../../assests/sub-banner-images/video-chat.svg";
  ...
  render() {
    return (
      <React.Fragment>
        <Helmet>
          <meta charSet="utf-8"/>
          <title>SaleAssist - Video Chat</title>
        </Helmet>
      <Layout1 btn="book-a-demo-white-btn safemeet-btn" color="safemeet-navitem white" activeClass="active-feature active-feature-white">
        <SubBanner
        banner={VideoChatImage}
          image={ViChat}
          span="Videochat"
          title="In-person visits, from a distance."
          details="Online face-to-face, visual communication performed with other Internet users by using a webcam with Saleassist."
          btn="Watch Demo"
          path="/video-chat-demo"/>
        <TrustCompanies/>
        <ShowUHow/>
        <SimpleCardShow/>
        <DoEvenMore/>
