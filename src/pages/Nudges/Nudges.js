...
import Nudg from "../../assests/sub-banner-icons/nudges.svg";
import NudgesImage from "../../assests/sub-banner-images/nudges.svg";
    ...
    return (
      ...
      <Layout1 btn="book-a-demo-white-btn safemeet-btn" color="safemeet-navitem white" activeClass="active-feature active-feature-white">
        ...
        banner={NudgesImage}
          image={Nudg}
          span="Nudges"
          title="Gentle reminder and offers."
          details="Nudges are the best way to showcase product and get attract customer to the product.It will help you in growing."
          btn="Watch Demo"
          path="/nudges-demo"/>
        <TrustCompanies/>
        <ShowUHow/>
