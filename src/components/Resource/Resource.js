    ...
    return (
      <React.Fragment>
        <div className="safemeet-navitem-item">
          <div
            className="safemeet-container safemeet-navitem-item-customer-row"
            style={{
              // background: "red",
              width: "75%",
              margin: " 0 auto",
          ...
          >
            <div className="safemeet-navitem-item-customer-row-col-1">
              ...
              <Link
                to={{ pathname: "https://platform.SaleAssist.ai/redoc" }}
                target="_parent"
            ...
            <div className="safemeet-navitem-item-customer-row-col-2">
              ...
              <div className="safemeet-mg-b-1"></div>
            </div>
            <div className="safemeet-navitem-item-customer-row-col-3 safemeet-text-center">
              ...
              <p>
                Book a demo to evaluate if Saleassist is right for your
                business.
              </p>
              <Link to="/demo">
                {" "}
                <button style={{
                  background: "#4285F4"
                }} className="safemeet-btn">BOOK A DEMO</button>
              </Link>
            </div>
          </div>
        </div>
